...
namespace WebApi.Controllers
{
    ...
    public class TasksController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("/api/Tasks/UpdateAssignedTo/{taskId}/{memberId}")]
        [ProducesResponseType(typeof(UpdateTaskAssignedToCommand), StatusCodes.Status200OK)]
        public async Task<IActionResult> UpdateAssignedTo(Guid taskId1, Guid memberId)
        {
            var result = await _taskService.UpdateTaskAssignedTo(taskId1, memberId);
            return Ok();
        }
